...
export default function Hero() {
  return (
    <div id="home" className=" text-white py-24 pt-28 w-[80%] mx-auto">
      <div className=" w-full relative">
        <div>
          <p className=" text-main-text-color">&gt; whoami</p>
          <div>
            <TypeAnimation
              sequence={[
        ...
        <div className=" flex flex-col justify-center items-start gap-5">
          <h1 className="text-6xl md:text-8xl font-mono font-black leading-tight tracking-tighter">
          ...
          <p className=" text-[#94A3B8] text-[18px] max-w-xl leading-8">
            Full-stack developer specializing in AI-powered applications, modern
            web experiences, and scalable architecture.
          </p>
          <div className=" flex justify-between max-w-lg gap-8 text-[14px]">
            <motion.button
